...
If you define a term, you may want to use the macro \texttt{\textbackslash introterm}, which produces a little note in the margin alerting the reader to the place of the \introterm{introterm}.
...
\section{Page Frames}
\seclabel{introduction:pageframes}
