...
% Leave the following headers empty: Right aligned on Even pages, and Left alignes on Odd pages
\fancyhead[RE,LO]{}
% On Even pages, put the section title into the Left header
\fancyhead[LE]{\textsl{\leftmark}}
% Leave the Center of the footer empty
\fancyfoot[C]{}
