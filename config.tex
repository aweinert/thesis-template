...
% This is the marker that is used in text before cross references.  Currently empty can e.g. be `\MVRightarrow\thinspace ' for an arrow in front of it, such as `-> Definition 5'.
